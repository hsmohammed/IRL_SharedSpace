...
objects_1111 <- read.csv(file = "Data/Objects/1-5-2-1.csv", header = FALSE)
objects_1111$V1 <- objects_1111$V1 +1
objects_1112 <- read.csv(file = "Data/Objects/1-5-2-17.csv", header = FALSE)
objects_1112$V1 <- objects_1112$V1 +1
objects_1113 <- read.csv(file = "Data/Objects/1-5-2-9915.csv",header = FALSE)
...
#Merged DataFrame 
Traj_Obj_152x_merged <- full_join(Traj_Obj_1111x,Traj_Obj_1112x)
Traj_Obj_152x_merged <- full_join(Traj_Obj_152x_merged,Traj_Obj_1113x)
...
Traj_Obj_152x_merged <- Traj_Obj_152x_merged %>%
