...
objects_1111 <- read.csv(file = "Data/Objects/1-6-1-8.csv", header = FALSE)
...
#Merged DataFrame 
Traj_Obj_161x_merged <- full_join(Traj_Obj_1111x,Traj_Obj_1112x)
...
Traj_Obj_161x_merged <- Traj_Obj_161x_merged %>%
