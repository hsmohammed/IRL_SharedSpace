...
objects_1111 <- read.csv(file = "Data/Objects/1-7-1-15.csv", header = FALSE)
...
#Merged DataFrame 
Traj_Obj_171x_merged <- full_join(Traj_Obj_1111x,Traj_Obj_1112x)
...
Traj_Obj_171x_merged <- Traj_Obj_171x_merged %>%
