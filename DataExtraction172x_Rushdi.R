...
objects_1111 <- read.csv(file = "Data/Objects/1-7-2-19.csv", header = T)
objects_1111$V1 <- objects_1111$Obj +1
objects_1112 <- read.csv(file = "Data/Objects/1-7-2-20.csv", header = T)
objects_1112$V1 <- objects_1112$Obj +1
objects_1113 <- read.csv(file = "Data/Objects/1-7-2-22.csv",header = T)
...
#Merged DataFrame 
Traj_Obj_172x_merged <- full_join(Traj_Obj_1111x,Traj_Obj_1112x)
Traj_Obj_172x_merged <- full_join(Traj_Obj_172x_merged,Traj_Obj_1113x)
# Traj_Obj_172x_merged <- full_join(Traj_Obj_172x_merged,Traj_Obj_1114x)
# Traj_Obj_172x_merged <- full_join(Traj_Obj_172x_merged,Traj_Obj_1115x)
# Traj_Obj_172x_merged <- full_join(Traj_Obj_172x_merged,Traj_Obj_1116x)
# Traj_Obj_172x_merged <- full_join(Traj_Obj_172x_merged,Traj_Obj_1117x)
# Traj_Obj_172x_merged <- full_join(Traj_Obj_172x_merged,Traj_Obj_1118x)
# Traj_Obj_172x_merged <- full_join(Traj_Obj_172x_merged,Traj_Obj_1119x)
# Traj_Obj_172x_merged <- full_join(Traj_Obj_172x_merged,Traj_Obj_11110x)


Traj_Obj_172x_merged <- Traj_Obj_172x_merged %>%
