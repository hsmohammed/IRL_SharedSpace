...
objects_1111 <- read.csv(file = "Data/Objects/1-7-2-19.csv", header = FALSE)
objects_1111$V1 <- objects_1111$V1 +1
objects_1112 <- read.csv(file = "Data/Objects/1-7-2-20.csv", header = FALSE)
objects_1112$V1 <- objects_1112$V1 +1
objects_1113 <- read.csv(file = "Data/Objects/1-7-2-22.csv",header = FALSE)
