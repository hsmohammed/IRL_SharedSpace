...
objects_1111 <- read.csv(file = "Data/Objects/1-8-2-27.csv", header = T)
objects_1111$V1 <- objects_1111$Obj +1
objects_1112 <- read.csv(file = "Data/Objects/1-8-2-28.csv", header = T)
objects_1112$V1 <- objects_1112$Obj +1
objects_1113 <- read.csv(file = "Data/Objects/1-8-2-29.csv",header = T)
objects_1113$V1 <- objects_1113$Obj +1
...
#Merged DataFrame 
Traj_Obj_182x_merged <- full_join(Traj_Obj_1111x,Traj_Obj_1112x)
Traj_Obj_182x_merged <- full_join(Traj_Obj_182x_merged,Traj_Obj_1113x)
# Traj_Obj_182x_merged <- full_join(Traj_Obj_182x_merged,Traj_Obj_1114x)
# Traj_Obj_182x_merged <- full_join(Traj_Obj_182x_merged,Traj_Obj_1115x)
# Traj_Obj_182x_merged <- full_join(Traj_Obj_182x_merged,Traj_Obj_1116x)
# Traj_Obj_182x_merged <- full_join(Traj_Obj_182x_merged,Traj_Obj_1117x)
# Traj_Obj_182x_merged <- full_join(Traj_Obj_182x_merged,Traj_Obj_1118x)
# Traj_Obj_182x_merged <- full_join(Traj_Obj_182x_merged,Traj_Obj_1119x)
# Traj_Obj_182x_merged <- full_join(Traj_Obj_182x_merged,Traj_Obj_11110x)


Traj_Obj_182x_merged <- Traj_Obj_182x_merged %>%
