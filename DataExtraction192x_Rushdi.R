...
objects_1111 <- read.csv(file = "Data/Objects/1-9-2-16.csv", header = FALSE)
...
#Merged DataFrame 
Traj_Obj_192x_merged <- full_join(Traj_Obj_1111x,Traj_Obj_1112x)
...
Traj_Obj_192x_merged <- Traj_Obj_192x_merged %>%
