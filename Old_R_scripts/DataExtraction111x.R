...
X11111 <- read.csv('Data/X-1-1-1-11.csv',header = FALSE)
X11111 <- X11111 %>% 
  gather(key = "measure_X", value = "X", 1:length(X11111))
X11111$measure_X <- str_replace(X11111$measure_X,"V","")

Y11111 <- read.csv('Data/Y-1-1-1-11.csv',header = FALSE)
Y11111 <- Y11111 %>% 
  gather(key = "measure_X", value = "Y", 1:length(Y11111))
Y11111$measure_X <- str_replace(Y11111$measure_X,"V","")

F11111 <- read.csv('Data/F-1-1-1-11.csv',header = FALSE)
F11111 <- F11111 %>% 
  gather(key = "measure_X", value = "F", 1:length(F11111))
F11111$measure_X <- str_replace(F11111$measure_X,"V","")

VX11111 <- read.csv('Data/VX-1-1-1-11.csv',header = FALSE)
VX11111 <- VX11111 %>% 
  gather(key = "measure_X", value = "VX", 1:length(VX11111))
VX11111$measure_X <- str_replace(VX11111$measure_X,"V","")

VY11111 <- read.csv('Data/VY-1-1-1-11.csv',header = FALSE)
VY11111 <- VY11111 %>% 
  gather(key = "measure_X", value = "VY", 1:length(VY11111))
VY11111$measure_X <- str_replace(VY11111$measure_X,"V","")

#11112

X11112 <- read.csv('Data/X-1-1-1-12.csv',header = FALSE)
X11112 <- X11112 %>% 
  gather(key = "measure_X", value = "X", 1:length(X11112))
X11112$measure_X <- str_replace(X11112$measure_X,"V","")

Y11112 <- read.csv('Data/Y-1-1-1-12.csv',header = FALSE)
Y11112 <- Y11112 %>% 
  gather(key = "measure_X", value = "Y", 1:length(Y11112))
Y11112$measure_X <- str_replace(Y11112$measure_X,"V","")

F11112 <- read.csv('Data/F-1-1-1-12.csv',header = FALSE)
F11112 <- F11112 %>% 
  gather(key = "measure_X", value = "F", 1:length(F11112))
F11112$measure_X <- str_replace(F11112$measure_X,"V","")

VX11112 <- read.csv('Data/VX-1-1-1-12.csv',header = FALSE)
VX11112 <- VX11112 %>% 
  gather(key = "measure_X", value = "VX", 1:length(VX11112))
VX11112$measure_X <- str_replace(VX11112$measure_X,"V","")

VY11112 <- read.csv('Data/VY-1-1-1-12.csv',header = FALSE)
VY11112 <- VY11112 %>% 
  gather(key = "measure_X", value = "VY", 1:length(VY11112))
VY11112$measure_X <- str_replace(VY11112$measure_X,"V","")

#11113

X11113 <- read.csv('Data/X-1-1-1-13.csv',header = FALSE)
X11113 <- X11113 %>% 
  gather(key = "measure_X", value = "X", 1:length(X11113))
X11113$measure_X <- str_replace(X11113$measure_X,"V","")

Y11113 <- read.csv('Data/Y-1-1-1-13.csv',header = FALSE)
Y11113 <- Y11113 %>% 
  gather(key = "measure_X", value = "Y", 1:length(Y11113))
Y11113$measure_X <- str_replace(Y11113$measure_X,"V","")

F11113 <- read.csv('Data/F-1-1-1-13.csv',header = FALSE)
F11113 <- F11113 %>% 
  gather(key = "measure_X", value = "F", 1:length(F11113))
F11113$measure_X <- str_replace(F11113$measure_X,"V","")

VX11113 <- read.csv('Data/VX-1-1-1-13.csv',header = FALSE)
VX11113 <- VX11113 %>% 
  gather(key = "measure_X", value = "VX", 1:length(VX11113))
VX11113$measure_X <- str_replace(VX11113$measure_X,"V","")

VY11113 <- read.csv('Data/VY-1-1-1-13.csv',header = FALSE)
VY11113 <- VY11113 %>% 
  gather(key = "measure_X", value = "VY", 1:length(VY11113))
VY11113$measure_X <- str_replace(VY11113$measure_X,"V","")

#11114

X11114 <- read.csv('Data/X-1-1-1-14.csv',header = FALSE)
X11114 <- X11114 %>% 
  gather(key = "measure_X", value = "X", 1:length(X11114))
X11114$measure_X <- str_replace(X11114$measure_X,"V","")

Y11114 <- read.csv('Data/Y-1-1-1-14.csv',header = FALSE)
Y11114 <- Y11114 %>% 
  gather(key = "measure_X", value = "Y", 1:length(Y11114))
Y11114$measure_X <- str_replace(Y11114$measure_X,"V","")

F11114 <- read.csv('Data/F-1-1-1-14.csv',header = FALSE)
F11114 <- F11114 %>% 
  gather(key = "measure_X", value = "F", 1:length(F11114))
F11114$measure_X <- str_replace(F11114$measure_X,"V","")

VX11114 <- read.csv('Data/VX-1-1-1-14.csv',header = FALSE)
VX11114 <- VX11114 %>% 
  gather(key = "measure_X", value = "VX", 1:length(VX11114))
VX11114$measure_X <- str_replace(VX11114$measure_X,"V","")

VY11114 <- read.csv('Data/VY-1-1-1-14.csv',header = FALSE)
VY11114 <- VY11114 %>% 
  gather(key = "measure_X", value = "VY", 1:length(VY11114))
VY11114$measure_X <- str_replace(VY11114$measure_X,"V","")

#Bicycle Object

objects_1111 <- read.csv(file = "objects_1111.csv", header = FALSE)
objects_1112 <- read.csv(file = "objects_1112.csv", header = FALSE)
objects_1113 <- read.csv(file = "objects_1113.csv",header = FALSE)
objects_1114 <- read.csv(file = "objects_1114.csv", header = FALSE)
objects_1115 <- read.csv(file = "objects_1115.csv",header = FALSE)
objects_1116 <- read.csv(file = "objects_1116.csv", header = FALSE)
objects_1117 <- read.csv(file = "objects_1117.csv",header = FALSE)
objects_1118 <- read.csv(file = "objects_1118.csv", header = FALSE)
objects_1119 <- read.csv(file = "objects_1119.csv",header = FALSE)
objects_11110 <- read.csv(file = "objects_11110.csv", header = FALSE)
objects_11111 <- read.csv(file = "objects_11111.csv",header = FALSE)
objects_11112 <- read.csv(file = "objects_11112.csv", header = FALSE)
objects_11113 <- read.csv(file = "objects_11113.csv",header = FALSE)
objects_11114 <- read.csv(file = "objects_11114.csv", header = FALSE)
