...
FN <- 29.97
Traj_Obj_161x_clipped <- Traj_Obj_161x_merged
Traj_Obj_161x_clipped2 <- Traj_Obj_161x_clipped %>% 
  group_by(comp) %>% 
  group_by(Obj) %>% 
...
Traj_Obj_161x_clipped2$Obj_ID <- factor(Traj_Obj_161x_clipped2$Obj_ID)  




Traj_Obj_161x_clipped2 <- Traj_Obj_161x_clipped2[complete.cases(Traj_Obj_161x_clipped2), ]

Traj_Obj_161x_clipped2 <- Traj_Obj_161x_clipped2 %>%
...
# Traj_Obj_161x_clipped2 <- Traj_Obj_161x_clipped2[c(FALSE,Traj_Obj_161x_clipped2$Obj[-1]==Traj_Obj_161x_clipped2$Obj[-(nrow(Traj_Obj_161x_clipped2)-1)]),]
