...
FN <- 29.97
Traj_Obj_162x_clipped <- Traj_Obj_162x_merged
Traj_Obj_162x_clipped2 <- Traj_Obj_162x_clipped %>% 
  group_by(comp) %>% 
  group_by(Obj) %>% 
...
Traj_Obj_162x_clipped2 <- Traj_Obj_162x_clipped2 %>% 
  group_by(Obj_ID) %>%
  mutate(yawRate_SGF = sgolayfilt(yawRate,p = 4,n = 13)) %>% 
...
Traj_Obj_162x_clipped2 <- Traj_Obj_162x_clipped2 %>% 
  group_by(Obj_ID) %>%
  mutate(jerk_SGF = sgolayfilt(jerk,p = 4,n = 13))
...
# Traj_Obj_162x_clipped2 <- Traj_Obj_162x_clipped2[c(FALSE,Traj_Obj_162x_clipped2$Obj[-1]==Traj_Obj_162x_clipped2$Obj[-(nrow(Traj_Obj_162x_clipped2)-1)]),]
