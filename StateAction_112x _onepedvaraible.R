...
bicycles_112x_variables<-states_and_actions_112x_2
...
states_112x <- states_112x %>% 
  dplyr::mutate(state_no = ((as.numeric(dist1_disc)-1)*25)+((as.numeric(YawDiff1_disc)-1)*5)+
...
trans_prob <- array(rep(0, 78125), dim = c(125,5,125))

trans_s <- array(rep(0, 78125), dim = c(125,5,125))
...
features_splittable <- matrix(rep(0,625),nrow = 125,ncol = 5)
...
#   
# }
writeMat("C:/Users/Rushdi/Desktop/Rushdi work/IRL modeling of shared sapce/New folder/SampleofTrajectoriesAnalysis/3statesand1action/state_mat.mat", state_mat = state_mat)

writeMat("C:/Users/Rushdi/Desktop/Rushdi work/IRL modeling of shared sapce/New folder/SampleofTrajectoriesAnalysis/3statesand1action/action_mat.mat", action_mat = action_mat)

writeMat("C:/Users/Rushdi/Desktop/Rushdi work/IRL modeling of shared sapce/New folder/SampleofTrajectoriesAnalysis/3statesand1action/features_splittable.mat", features_splittable = features_splittable)


writeMat("C:/Users/Rushdi/Desktop/Rushdi work/IRL modeling of shared sapce/New folder/SampleofTrajectoriesAnalysis/3statesand1action/trans_prob.mat", trans_prob = trans_prob)

writeMat("C:/Users/Rushdi/Desktop/Rushdi work/IRL modeling of shared sapce/New folder/SampleofTrajectoriesAnalysis/3statesand1action/trans_s.mat", trans_s = trans_s)
