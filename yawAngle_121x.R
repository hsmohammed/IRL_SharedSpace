...
Traj_Obj_121x_clipped3 <- Traj_Obj_121x_clipped2

Traj_Obj_121x_clipped3$X_SGF

tables_XY <- read.csv("Map/tables_XY-121x.csv")
...
ggsave(filename = "Map/tables_XY-121x.jpg",p1)

#calculate rotation angle
RotationAngle <- atan(abs(tables_XY$X[1]-tables_XY$X[2])/abs(tables_XY$Y[1]-tables_XY$Y[2]))

Traj_Obj_121x_clipped3 <- Traj_Obj_121x_clipped3 %>% 
...
Traj_Obj_121x_clipped3 <- Traj_Obj_121x_clipped3[complete.cases(Traj_Obj_121x_clipped3),]
