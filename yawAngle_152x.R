...
Traj_Obj_152x_clipped3 <- Traj_Obj_152x_clipped2

Traj_Obj_152x_clipped3$X_SGF

tables_XY <- read.csv("Map/tables_XY-152x.csv")
...
ggsave(filename = "Map/tables_XY-151x.jpg",p1)
...
Traj_Obj_152x_clipped3 <- Traj_Obj_152x_clipped3[complete.cases(Traj_Obj_152x_clipped3),]
