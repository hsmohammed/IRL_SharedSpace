...
Traj_Obj_182x_clipped3 <- Traj_Obj_182x_clipped2

Traj_Obj_182x_clipped3$X_SGF

tables_XY <- read.csv("Map/tables_XY-182x.csv")
...
ggsave(filename = "Map/tables_XY-182x.jpg",p1)

#calculate rotation angle
RotationAngle <- atan(abs(tables_XY$X[1]-tables_XY$X[2])/abs(tables_XY$X[1]-tables_XY$X[2]))

Traj_Obj_182x_clipped3 <- Traj_Obj_182x_clipped3 %>% 
...
Traj_Obj_182x_clipped3 <- Traj_Obj_182x_clipped3[complete.cases(Traj_Obj_182x_clipped3),]
