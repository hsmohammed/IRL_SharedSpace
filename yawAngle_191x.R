...
Traj_Obj_191x_clipped3 <- Traj_Obj_191x_clipped2

Traj_Obj_191x_clipped3$X_SGF

tables_XY <- read.csv("Map/tables_XY-191x.csv")
...
Traj_Obj_191x_clipped3 <- Traj_Obj_191x_clipped3[complete.cases(Traj_Obj_191x_clipped3),]
