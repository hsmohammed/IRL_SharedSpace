...
Traj_Obj_192x_clipped3 <- Traj_Obj_192x_clipped2

Traj_Obj_192x_clipped3$X_SGF

tables_XY <- read.csv("Map/tables_XY-192x.csv")
...
Traj_Obj_192x_clipped3 <- Traj_Obj_192x_clipped3[complete.cases(Traj_Obj_192x_clipped3),]
